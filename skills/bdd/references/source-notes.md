...
This BDD skill is a structured guide derived from primary BDD/Cucumber references rather than a verbatim copy of any one source.
...
- Cucumber docs, **Gherkin reference**, **Writing better Gherkin**, **Step organization**, **Step definitions**, **Cucumber reference**, **Anti-patterns**, and **FAQ**: provide the practical style rules and anti-pattern guidance.
